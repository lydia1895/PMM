...
function [Rsum,Tsum, M, gammaminus] =...
    ...
    L_EH = zeros(2*N_total_3,2*N_total_3,L);
    L_EH = zeros(2*N_total_3,2*N_total_3,L);
    ...
    for i_lambda_eig=1:Nlambda_eig
        for j_theta_eig=1:Ntheta_eig
            for k_phi_eig=1:Nphi_eig
                ...
                i_lambda_perturb = (n_lambda_extra_perturb-1)/2 + 0 +...
                ...
                lambda = lambda_full(i_lambda_eig)
                ...
                for nlayer=1:L
                    ...
                    Lfull_eig = L_HE_eig*L_EH_eig;
                    
                    [H_eig,gammasqr_eig] = PMM_eig_for_Maxwell(Lfull_eig);
                    ...
                    for i_perturb = -(n_lambda_extra_perturb-1)/2:(n_lambda_extra_perturb-1)/2
                        if i_perturb ~=0
                            ...
                            i_lambda_perturb = (n_lambda_extra_perturb-1)/2 + i_perturb +...
                                (i-1)*n_lambda_extra_perturb;
