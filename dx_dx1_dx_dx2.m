function [matrix_dx_dx1_dx_dx2_for_Ex,ellipse_matrix_dx_dx1_dx_dx2_for_Ex,...
...
matrix_dx_dx1_dx_dx2_for_Ex = zeros(N_total_3,N_total_3);
matrix_dx_dx1_dx_dx2_for_Ey = zeros(N_total_3,N_total_3);
for num_x = 1:3
    for num_y = 1:3
        if num_x~=2
            %for Ex
            ...
            matrix_dx_dx1_dx_dx2_for_Ex = matrix_dx_dx1_dx_dx2_for_Ex + matrix_x_y;
            %for Ey
            comp_x(1,:) = dx_dx1_dx_dx2_comp_x(num_x,num_y,:); 
            matrix_comp_x = polyfit_1D_and_matrices(comp_x,ksi,...
            ...
            matrix_x_y = kron(matrix_comp_x,matrix_comp_y);
            matrix_dx_dx1_dx_dx2_for_Ey = matrix_dx_dx1_dx_dx2_for_Ey + matrix_x_y;
        else
            %for Ex
            ...
            matrix_dx_dx1_dx_dx2_for_Ex = matrix_dx_dx1_dx_dx2_for_Ex + matrix_x1_y1 + matrix_x2_y2;
            if (num_x==2)&&(num_y==2)
                ellipse_matrix_dx_dx1_dx_dx2_for_Ex = matrix_x1_y1 + matrix_x2_y2;
            end
            %for Ey    
            comp_x(1,:) = dx_dx1_dx_dx2_on2_x1_comp_x_1(num_x,num_y,:); 
            matrix_comp_x_1 = polyfit_1D_and_matrices(comp_x,ksi,...
            ...
            matrix_dx_dx1_dx_dx2_for_Ey = matrix_dx_dx1_dx_dx2_for_Ey + matrix_x1_y1 + matrix_x2_y2;
            if (num_x==2)&&(num_y==2)
                ellipse_matrix_dx_dx1_dx_dx2_for_Ey = matrix_x1_y1 + matrix_x2_y2;
            end
