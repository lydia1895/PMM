function [matrix_dy_dx1_dy_dx2,ellipse_matrix_dy_dx1_dy_dx2]=...
...
matrix_dy_dx1_dy_dx2 = zeros(N_total_3,N_total_3);
for num_x = 1:3
    for num_y = 1:3
        if num_y~=2
            ...
            matrix_dy_dx1_dy_dx2 = matrix_dy_dx1_dy_dx2 + matrix_x_y;
            ...
            matrix_dy_dx1_dy_dx2 = matrix_dy_dx1_dy_dx2 + matrix_x1_y1 + matrix_x2_y2;
            if (num_x==2)&&(num_y==2)
                ellipse_matrix_dy_dx1_dy_dx2 = matrix_x1_y1 + matrix_x2_y2;
            end
