...
int_g(:,:,1)=int_Ez_sqrt_g_full;
int_g(:,:,2)=int_Dz_unity_full;
int_g(:,:,3)=int_Dx_sqrt_g_full;
int_g(:,:,4)=int_Dy_sqrt_g_full;
int_g(:,:,5)=int_Ex_g_down22_full;
int_g(:,:,6)=int_Ey_g_down12_full;
int_g(:,:,7)=int_Ex_g_down21_full;
int_g(:,:,8)=int_Ey_g_down11_full;

int_for_ellipse(:,:,1)=int_Ex_g_down22(2,2,:,:);
int_for_ellipse(:,:,2)=int_Ey_g_down12(2,2,:,:);
int_for_ellipse(:,:,3)=int_Ex_g_down21(2,2,:,:);
int_for_ellipse(:,:,4)=int_Ey_g_down11(2,2,:,:);
int_for_ellipse(:,:,5)=int_Ez_sqrt_g(2,2,:,:);
