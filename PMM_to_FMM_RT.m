function [fx_coef,ud_FMM,x1,x2] = PMM_to_FMM_RT(ud_PMM, N, NN, La,...
   alpha_ref, beta_ref, alpha0, beta0, alpha_v, beta_v, ...
...
alpha_p = alpha0 - alpha_ref - alpha_v
beta_p = beta0 - beta_ref - beta_v
