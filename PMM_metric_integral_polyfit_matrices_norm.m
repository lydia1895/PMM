...
[g_sqrt_12_fit] = polyfit_procedure(x1_1,x2_2,g_sqrt_12_raw);
[g_sqrt_21_fit] = polyfit_procedure(x1_2,x2_1,g_sqrt_21_raw);
[g_sqrt_22_fit] = polyfit_procedure(x1_2,x2_2,g_sqrt_22_raw);
[g_sqrt_23_fit] = polyfit_procedure(x1_2,x2_3,g_sqrt_23_raw);
[g_sqrt_32_fit] = polyfit_procedure(x1_3,x2_2,g_sqrt_32_raw);

[g_down11_12_fit] = polyfit_procedure(x1_1,x2_2,g_down11_12_raw);
[g_down11_21_fit] = polyfit_procedure(x1_2,x2_1,g_down11_21_raw);
[g_down11_22_fit] = polyfit_procedure(x1_2,x2_2,g_down11_22_raw);
[g_down11_23_fit] = polyfit_procedure(x1_2,x2_3,g_down11_23_raw);
[g_down11_32_fit] = polyfit_procedure(x1_3,x2_2,g_down11_32_raw);

[g_down22_12_fit] = polyfit_procedure(x1_1,x2_2,g_down22_12_raw);
[g_down22_21_fit] = polyfit_procedure(x1_2,x2_1,g_down22_21_raw);
[g_down22_22_fit] = polyfit_procedure(x1_2,x2_2,g_down22_22_raw);
[g_down22_23_fit] = polyfit_procedure(x1_2,x2_3,g_down22_23_raw);
[g_down22_32_fit] = polyfit_procedure(x1_3,x2_2,g_down22_32_raw);

[g_down12_12_fit] = polyfit_procedure(x1_1,x2_2,g_down12_12_raw);
[g_down12_21_fit] = polyfit_procedure(x1_2,x2_1,g_down12_21_raw);
[g_down12_22_fit] = polyfit_procedure(x1_2,x2_2,g_down12_22_raw);
[g_down12_23_fit] = polyfit_procedure(x1_2,x2_3,g_down12_23_raw);
[g_down12_32_fit] = polyfit_procedure(x1_3,x2_2,g_down12_32_raw);
