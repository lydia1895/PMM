...
epsilon = zeros(2,L);
epsilon(:,4) = epsAir*ones(2,1);
epsilon(:,3) = epsAir*ones(2,1);
epsilon(:,2) = epsSiO2*ones(2,1);
epsilon(:,1) = epsSi*ones(2,1);
epsilon(2,3) = epsSi; %ellipses
...
[hx, Dx, nx, Nx, dx_x1,dx_x2,dy_x1,dy_x2,ax,ay,Rsum_ellipses,Tsum_ellipses,...
